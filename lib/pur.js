...
(function() {
  var ALWAYS, BubbleWrap, Defer, FIN, INI, Pur, STOP, StepFun, allResolver, alwaysResolver, cnt, failResolver, k, spreadResolver, stepResolver, stepWith, stepWithF, thenResolver, v,
  ...
  BubbleWrap = (function(_super) {
    ...
    BubbleWrap.prototype.message = 'BubbleWrap';
